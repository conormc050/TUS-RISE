...
struct SettingsView: View {
    @AppStorage("liftiq.theme") private var theme = "system"
    @AppStorage("liftiq.viewMode") private var viewMode = "simple"
    @AppStorage("liftiq.athlete") private var athlete = "Athlete"
